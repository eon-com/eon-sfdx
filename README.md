...
@eon-com/eon-sfdx/1.4.0 darwin-x64 node-v16.6.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
<!-- commands -->
* [`sfdx eon:beta:package:devkit:apply -p <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-eonbetapackagedevkitapply--p-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx eon:beta:package:devkit:create -p <string> [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-eonbetapackagedevkitcreate--p-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
* [`sfdx eon:beta:package:devkit:testdata:retrieve -p <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-eonbetapackagedevkittestdataretrieve--p-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
* [`sfdx eon:package:validate [-t <string>] [-s <string>] [-d] [-p <string>] [-g <string>] [-a <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-eonpackagevalidate--t-string--s-string--d--p-string--g-string--a-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
## `sfdx eon:beta:package:devkit:apply -p <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Applys scripts and testdata of a devkit to an scratch org

```
USAGE
  $ sfdx eon:beta:package:devkit:apply -p <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel 
...
_See code: [src/commands/eon/beta/package/devkit/apply.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/beta/package/devkit/apply.ts)_

## `sfdx eon:beta:package:devkit:create -p <string> [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Initialize a devkit for a package

```
USAGE
  $ sfdx eon:beta:package:devkit:create -p <string> [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]
...
_See code: [src/commands/eon/beta/package/devkit/create.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/beta/package/devkit/create.ts)_

## `sfdx eon:beta:package:devkit:testdata:retrieve -p <string> [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Applys scripts and testdata of a devkit to an scratch org

```
USAGE
  $ sfdx eon:beta:package:devkit:testdata:retrieve -p <string> [-u <string>] [--apiversion <string>] [--json] 
...
_See code: [src/commands/eon/beta/package/devkit/testdata/retrieve.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/beta/package/devkit/testdata/retrieve.ts)_
...
_See code: [src/commands/eon/commit.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/commit.ts)_
...
_See code: [src/commands/eon/org/features/update.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/org/features/update.ts)_
...
_See code: [src/commands/eon/org/gettype.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/org/gettype.ts)_
...
_See code: [src/commands/eon/package/deploy.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/package/deploy.ts)_

## `sfdx eon:package:validate [-t <string>] [-s <string>] [-d] [-p <string>] [-g <string>] [-a <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Validation Job to check package changes on scratch

```
USAGE
  $ sfdx eon:package:validate [-t <string>] [-s <string>] [-d] [-p <string>] [-g <string>] [-a <string>] [-u <string>] 
...
_See code: [src/commands/eon/package/validate.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/package/validate.ts)_
...
_See code: [src/commands/eon/package/validate/source.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/package/validate/source.ts)_
...
_See code: [src/commands/eon/update/customlabel.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/update/customlabel.ts)_
...
_See code: [src/commands/eon/update/externaldatasource.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/update/externaldatasource.ts)_
...
_See code: [src/commands/eon/update/metadata.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/update/metadata.ts)_
...
_See code: [src/commands/eon/update/namedcredential.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/update/namedcredential.ts)_
...
_See code: [src/commands/eon/upsert/customsetting.ts](https://github.com/eon-com/eon-sfdx/blob/v1.4.0/src/commands/eon/upsert/customsetting.ts)_
<!-- commandsstop -->
