...
@eon-com/eon-sfdx/1.1.2-beta.4 darwin-x64 node-v16.6.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
* [`sfdx eon:package:validate [-t <string>] [-s <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-eonpackagevalidate--t-string--s-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
_See code: [src/commands/eon/commit.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/commit.ts)_
...
_See code: [src/commands/eon/package/deploy.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/package/deploy.ts)_

## `sfdx eon:package:validate [-t <string>] [-s <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Validation Job to check package changes on scratch

```
USAGE
  $ sfdx eon:package:validate [-t <string>] [-s <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]
...
_See code: [src/commands/eon/package/validate.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/package/validate.ts)_
...
_See code: [src/commands/eon/update/customlabel.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/update/customlabel.ts)_
...
_See code: [src/commands/eon/update/externaldatasource.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/update/externaldatasource.ts)_
...
_See code: [src/commands/eon/update/metadata.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/update/metadata.ts)_
...
_See code: [src/commands/eon/update/namedcredential.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/update/namedcredential.ts)_
...
_See code: [src/commands/eon/upsert/customsetting.ts](https://github.com/eon-com/eon-sfdx/blob/v1.1.2-beta.4/src/commands/eon/upsert/customsetting.ts)_
<!-- commandsstop -->
